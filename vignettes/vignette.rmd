...
The `glow` package is a framework for creating plots with glowing points. This provides an alternative and complementary way of plotting large point clouds while naturally showing point density. `glow` can easily handle millions or even billions of data points and plot them without binning or summarization.  
