...
|-|-|
|![](vignettes/volcano.png "volcano.png"){height=240px} | ![](vignettes/glow_spiral2.png "glow_spiral2.png"){height=240px}|
...
|-|
| ![](vignettes/gps_trace_8K_downsample.png "gps_trace_8K_downsample.png"){height=300px} |

| Clifford strange attractor (1 billion points) |
|-|
| ![](vignettes/clifford_distance_inverse_viridis_50_downsample.png "clifford_distance_inverse_viridis_50_downsample.png"){height=300px} |

| Airline Dataset (145 million points) | Diamonds |
|-|-|
| ![](vignettes/airline_mt.png "airline_mt.png"){height=240px} | ![](vignettes/diamonds.png "diamonds.png"){height=240px} |
...
See the help files and `inst/examples/` for more information and examples. 
